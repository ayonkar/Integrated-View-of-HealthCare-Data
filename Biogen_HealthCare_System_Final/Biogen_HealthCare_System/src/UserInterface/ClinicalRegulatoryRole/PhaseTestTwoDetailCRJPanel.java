 ...
 * @author Lenovo
 */
public class PhaseTestTwoDetailCRJPanel extends javax.swing.JPanel {

    /**
     * Creates new form PhaseTestTwoDetailCRJPanel
     */
    ...
    public PhaseTestTwoDetailCRJPanel(JPanel userProcessContainer, UserAccount userAccount ,ClinicalRegulatoryOrganisation organization, ClinicalDrugPhaseTwoTestWorkRequest cdtwr) {
        initComponents();
    ...
    private void getResultjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getResultjButtonActionPerformed
        ...
        solubilityjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatecompoundSolubility())));
        populatecolour(solubilityjTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatecompoundSolubility());

        gastricjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateGastricEmptyingTime())));
        populatecolour(gastricjTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateGastricEmptyingTime());

        transitTimejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateintestinalTransitTime())));
        populatecolour(transitTimejTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateintestinalTransitTime());

        chemicalInstabilityjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatechemicalInstability())));
        populatecolour(chemicalInstabilityjTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatechemicalInstability());

        formationjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateglucuronideFormation())));
        populatecolour(formationjTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateglucuronideFormation());

        dissolution.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculaterateOfDissolution())));
        populatecolour(dissolution,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculaterateOfDissolution());

        logPjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatecLogPvalue())));
        populatecolour(logPjTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatecLogPvalue());

        FlowratejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatebloodFlowRate())));
        populatecolour(FlowratejTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatebloodFlowRate());

        serumProteinjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateserumProtein())));
        populatecolour(serumProteinjTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateserumProtein());

        molecularSizejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatemolecularSize())));
        populatecolour(molecularSizejTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatemolecularSize());

        polarityjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatepolarity())));
        populatecolour(polarityjTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatepolarity());

        drugConcentrationjTextField1.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatedrugConcentration())));
        populatecolour(drugConcentrationjTextField1,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculatedrugConcentration());

        HalfLifejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateplasmaHalfLife())));
        populatecolour(HalfLifejTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateplasmaHalfLife());

        clearanceTimejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateclearanceTime())));
        populatecolour(clearanceTimejTextField,cdtwr.getPhaseTwoDrug().getPharmacokinetics().calculateclearanceTime());
...
//        dwjp.populateTable();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int y = cdtwr.getPhaseTwoDrug().getPharmacokinetics().getNumberHealthyPeople()+ cdtwr.getPhaseTwoDrug().getPharmacokinetics().getUnhealthyPeople() ;  //takes the number of people in the test
