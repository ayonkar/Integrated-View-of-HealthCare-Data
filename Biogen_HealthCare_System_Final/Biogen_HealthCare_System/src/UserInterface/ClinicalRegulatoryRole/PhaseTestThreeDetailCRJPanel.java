 ...
 * @author Lenovo
 */
public class PhaseTestThreeDetailCRJPanel extends javax.swing.JPanel {

    /**
     * Creates new form PhaseTestThreeDetailCRJPanel
     */
    ...
    public PhaseTestThreeDetailCRJPanel(JPanel userProcessContainer, UserAccount userAccount ,ClinicalRegulatoryOrganisation organization, ClinicalDrugPhaseThreeTestWorkRequest cdtwr) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText(" Molecular size μm ");
    ...
    private void getResultjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getResultjButtonActionPerformed
        ...
        solubilityjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatecompoundSolubility())));
        populatecolour(solubilityjTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatecompoundSolubility());

        gastricjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateGastricEmptyingTime())));
        populatecolour(gastricjTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateGastricEmptyingTime());

        transitTimejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateintestinalTransitTime())));
        populatecolour(transitTimejTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateintestinalTransitTime());

        chemicalInstabilityjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatechemicalInstability())));
        populatecolour(chemicalInstabilityjTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatechemicalInstability());

        formationjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateglucuronideFormation())));
        populatecolour(formationjTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateglucuronideFormation());

        dissolution.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculaterateOfDissolution())));
        populatecolour(dissolution,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculaterateOfDissolution());

        logPjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatecLogPvalue())));
        populatecolour(logPjTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatecLogPvalue());

        FlowratejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatebloodFlowRate())));
        populatecolour(FlowratejTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatebloodFlowRate());

        serumProteinjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateserumProtein())));
        populatecolour(serumProteinjTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateserumProtein());

        molecularSizejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatemolecularSize())));
        populatecolour(molecularSizejTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatemolecularSize());

        polarityjTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatepolarity())));
        populatecolour(polarityjTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatepolarity());

        drugConcentrationjTextField1.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatedrugConcentration())));
        populatecolour(drugConcentrationjTextField1,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculatedrugConcentration());

        HalfLifejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateplasmaHalfLife())));
        populatecolour(HalfLifejTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateplasmaHalfLife());

        clearanceTimejTextField.setText(String.valueOf(df.format(cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateclearanceTime())));
        populatecolour(clearanceTimejTextField,cdtwr.getPhaseThreeDrug().getPharmacokinetics().calculateclearanceTime());
...
//        dwjp.populateTable();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int y = cdtwr.getPhaseThreeDrug().getPharmacokinetics().getNumberHealthyPeople()+ cdtwr.getPhaseThreeDrug().getPharmacokinetics().getUnhealthyPeople() ;  //takes the number of people in the test
