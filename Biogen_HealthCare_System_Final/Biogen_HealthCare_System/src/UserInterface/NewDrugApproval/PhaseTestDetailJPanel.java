 ...
 * @author Lenovo
 */
public class PhaseTestDetailJPanel extends javax.swing.JPanel {
    ...
    public PhaseTestDetailJPanel( JPanel userprocesscontainer,NewDrugApprovalOrganisation organization,ClinicalDrugPhaseOneTestWorkRequest cdtwr,Enterprise enterprise) {
        initComponents();
        ...
        preferredDosejTextField.setText(String.valueOf(cdtwr.getCpd().getDoseLevel()));
    ...
    private void requestMonitoringjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestMonitoringjButtonActionPerformed
        // TODO add your handling code here:
        try{ Calendar choosenDate = jDateChooser.getCalendar();
            ...
            ClinicalPhaseOneDrug clinicalDrug = cdtwr.getCpd();
        ...
        catch(Exception e ){System.out.println(" Input not valid ");}
