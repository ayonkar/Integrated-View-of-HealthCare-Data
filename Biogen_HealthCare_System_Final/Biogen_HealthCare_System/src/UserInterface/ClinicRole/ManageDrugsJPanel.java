...
public class ManageDrugsJPanel extends javax.swing.JPanel {
  ...
  public void refreshTable(){
       ...
       DefaultTableModel model = (DefaultTableModel) clinicCartJTable.getModel();
       model.setRowCount(0); 
    ...
    private void initComponents() {
        ...
        clinicCartJTable = new javax.swing.JTable();
        ...
        jScrollPane3.setViewportView(clinicJTable);

        searchTextField.setText("Search DrugId");
        ...
        clinicCartJTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane4.setViewportView(clinicCartJTable);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
                int row = clinicCartJTable.getSelectedRow();
        if(row<0){
            JOptionPane.showMessageDialog(null, "Please select a row!", "Warning", JOptionPane.WARNING_MESSAGE);
        }
        OrderDrugItem oi = (OrderDrugItem)clinicCartJTable.getValueAt(row, 1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{int row = clinicJTable.getSelectedRow();
        if(row<0){
            JOptionPane.showMessageDialog(null, "Please select a row!", "Warning", JOptionPane.WARNING_MESSAGE);
        }
         MarketDrug md = (MarketDrug)clinicJTable.getValueAt(row, 1);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        ...
        catch(Exception e ){System.out.println(" Error if not selected from table ");}
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        int selectedRow = clinicJTable.getSelectedRow();
        if(selectedRow < 0)
        {
            JOptionPane.showMessageDialog(null,"Please select a row");
            return;
        }
        MarketDrug selectedDrug = (MarketDrug)clinicJTable.getValueAt(selectedRow,1);
        ...
        if(fetchQuantity <= selectedDrug.getQuantity())
            {
                ...
                for(OrderDrugItem oi : orderdrug.getOrderdrugList()){        
                            ...
                            if(!alreadyPresent)
                            {
                                ...
                                selectedDrug.setQuantity(newAvail);
                                Clinic clinic = (Clinic)clinicJComboBox.getSelectedItem();
                                orderdrug.addOrderItemClinic(selectedDrug, fetchQuantity,clinic);
                                populateTable();
                                refreshTable();
                            }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        int selectedRow = clinicCartJTable.getSelectedRow();
        if(selectedRow < 0)
        {
            JOptionPane.showMessageDialog(null,"Please select a row");
            return;
        }
        OrderDrugItem oi = (OrderDrugItem)clinicCartJTable.getValueAt(selectedRow, 1);
    ...
    private javax.swing.JTable clinicCartJTable;
